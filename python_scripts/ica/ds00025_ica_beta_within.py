...
for no_of_component in NO_OF_COMPONENTS:
    ...
    for turn, subject in enumerate(SUBJECTS):
        ...
        regressor_mat_file_path = f"E:\\ds000205\\sub-{subject}\\GICA_{no_of_component}\\infomax_icasso_temporal_regression.mat"
        ...
        for model in ML_MODELS:
            result = get_test_set_accuracy(X, Y, model, CV_FOLDS, None)
...
df.to_csv("../../output/ds00025_within_ica_results.csv")