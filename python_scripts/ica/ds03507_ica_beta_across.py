...
for no_of_component in NO_OF_COMPONENTS:
    ...
    for turn, subject in enumerate(SUBJECTS):
        ...
        for model in ML_MODELS:
            result = get_test_set_accuracy_across(X, X_all[turn], Y, Y_all[turn], model)
...
df.to_csv("../../output/ds03507_across_ica_results.csv")